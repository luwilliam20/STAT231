...
> RESPONSE: This implies that there is a weak relationship between the x and y in the dino dataset. This is because it looks like the R^2 will be around .036, which means very little of the variability is accounted for in the model.
...
> RESPONSE: It literally looks like a t-rex which is so funny.
